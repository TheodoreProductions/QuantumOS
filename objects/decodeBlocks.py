...
def decodeText(textlist, p, c):
    ...
    for text in textlist:
        ...
        if text[0] == 'A':
            ...
            rectlist.append([x * p, y * p, 3 * p, 3 * p, (0, 0, 0)])
            rectlist.append([x * p + 3 * p, y * p, 3 * p, 3 * p, (255, 0, 255)])
            rectlist.append([x * p, y * p + 3 * p, 3 * p, 3 * p, (255, 0, 255)])
            rectlist.append([x * p + 3 * p, y * p + 3 * p, 3 * p, 3 * p, (0, 0, 0)])
    return rectlist